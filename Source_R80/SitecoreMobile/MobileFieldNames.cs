...
namespace SitecoreMobile
{
    public static class MobileFieldNames
    {
        ...
        public static class StandardFormViewRenderingParameters
        {
            public static readonly string FormName = "FormName";
            public static readonly string FormControllerAction = "FormControllerAction";
            public static readonly string FormControllerName = "FormControllerName";
            public static readonly string FormFieldName = "FormFieldName";
            public static readonly string FormFieldTitle = "FormFieldTitle";
            public static readonly string FormFieldValue = "FormFieldValue";
            public static readonly string FormFieldReadOnly = "ReadOnly";
            public static readonly string FormFieldValueControllerAction = "FormFieldValueControllerAction";
            public static readonly string FormFieldValueControllerName = "FormFieldValueControllerName";
            public static readonly string FormSuccessRedirectResultItem = "FormSuccessRedirectResultItem";
        ...
        public static class TextViewRenderingParameters
        {
            public static readonly string DataInline = "DataInline";
            public static readonly string DataMini = "DataMini";
            public static readonly string DataRole = "DataRole";
        ...
        public static class ButtonViewRenderingParameters
        {
            ...
            public static readonly string ButtonRole = "ButtonRole";
            public static readonly string ButtonStyle = "ButtonStyle";
        }
        ...
        public static class ListViewRenderingParameters
        {
            ...
            public static readonly string DisplayEmptyMessageDatasource = "DisplayEmptyMessageDatasource";
            
            public static readonly string DisplayField01 = "DisplayField01";
            public static readonly string DisplayField02 = "DisplayField02";

            public static readonly string CountPlaceholderName = "CountPlaceholderName";
            public static readonly string CustomPlaceholderName = "CustomPlaceholderName";
            public static readonly string ChildPlaceholderName = "ChildPlaceholderName";            
        ...
        public static class ControlGroupViewRenderingParameters
        {
            ...
            public static readonly string CssClass = "CssClass";
            public static readonly string SeparatorString = "SeparatorString";
        ...
        public static class BarcodeViewRenderingParameters
        {
            public static readonly string BarcodeFormat = "BarcodeFormat";
            public static readonly string ImageFormat = "ImageFormat";
            public static readonly string WidthPx = "WidthPx";
            public static readonly string HeightPx = "HeightPx";
        ...
        public static class BarcodeControllerViewRenderingParameters
        {
            public static readonly string BarcodeControllerAction = "BarcodeControllerAction";
            public static readonly string BarcodeControllerName = "BarcodeControllerName";
